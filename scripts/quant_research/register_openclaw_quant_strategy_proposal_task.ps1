...
$runnerPath = Join-Path $repoRoot "scripts\\quant_research\\run_openclaw_quant_strategy_proposal_cycle_runner.ps1"
$legacyTaskNames = @(
    "OpenClaw Quant Exploration Weekly Cycle",
    "OpenClaw Quant Exploration Weekly Cycle Startup Catch-up"
)
