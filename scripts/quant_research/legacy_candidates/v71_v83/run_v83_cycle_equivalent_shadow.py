...
from enhengclaw.quant_research.shadow_oos import ShadowOOSConfig, run_cycle_equivalent_shadow


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Replay v83 (xs_minimal_v3) under the cycle's walk-forward sparse-window sharpe methodology, evaluating multiple portfolio constructions in parallel."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    summary = run_cycle_equivalent_shadow(config)
